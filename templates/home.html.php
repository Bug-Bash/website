<?php
    function bash_badge($bash)
    {
        ...
        if ($bash['id'] != 'unknown') {
            ...
            <a href='#' data-toggle='modal' data-target='#{$bash['id']}_attendees_modal'><span class='badge' style='background: #FFBB66; color: #000000'>" . count($attendees) . " Participants</span></a>
            </p>";
